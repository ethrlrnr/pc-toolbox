...
- **Mirroring GCP environment** when a project is deleted on the GCP, our account group and user role cron scripts will clean up left over items (account groups and roles associated with the deleted project). 
