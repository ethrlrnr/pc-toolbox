...
alert_info["dismissalNote"] = 'Alert(s) reopened from API. Action can be tracked in Prisma audit logs. Please reach out to Risk & Security for more information.'
...
pc_settings, response_package = pc_lib_api.api_reopen_alert_post(pc_settings, data=alert_info)
print('Done.')
