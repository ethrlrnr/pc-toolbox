...
user_list = response_package['data']
print('Done.')
...
pu = pandas.json_normalize(user_list) #put json inside a dataframe
pu.to_csv('prisma_user_list_{}.csv'.format(now), sep=',', encoding='utf-8') 
print('Done.')
