...
pu = pandas.json_normalize(anomalies_trusted_list) #put json inside a dataframe
pu.to_csv('anomalies_trusted_list_{}.csv'.format(now), sep=',', encoding='utf-8', index=False) 
print('Done.')
