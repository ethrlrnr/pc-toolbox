...
for policy_item in policy_v2_list:
    ...
    scans_df = pandas.json_normalize(policy_item)  # put json inside a dataframe
    scans_df = scans_df[sorted(scans_df.columns)]  # sorting columns alphabetically to match the header of the file
