...
pu = pandas.json_normalize(third_party_get) #put json inside a dataframe
...
pu.to_csv('third_party_get_{}.csv'.format(now), sep=',', encoding='utf-8', index=False, date_format='%m-%d-%y || %I:%M:%S %p CDT%z') 
print('Done.')
